                    ...
                    <tbody>
                        <?php
                            while($user_data = mysqli_fetch_assoc($resultado)){
                                echo "<tr>";
                                echo "<td>".$user_data['generos']."</td>";
                                echo "<td>
                                <a class='btnEditar' href='editar_generos.php?id=$user_data[id]'>Editar</a>
                                <a class='btnExcluir' href='excluir_generos.php?id=$user_data[id]'>Excluir</a>
                                </td>";
                                echo "</tr>";
                            }
                        ?>
