...
$conexao->query("INSERT INTO livros (titulo, genero_id, resumo, estoque) VALUES ('$titulo', $genero_id, '$resumo', $estoque)");
...
$resultGeneros = $conexao->query("SELECT id, categoria FROM generos ORDER BY categoria");
?>
            ...
            <div id="dados-direita">
                ...
                <select name="genero_id" class="genero" required>
                    ...
                    while ($row = $resultGeneros->fetch_assoc()) {
                        echo '<option value="' . $row['id'] . '">' . htmlspecialchars($row['categoria']) . '</option>';
                    }
                    ?>
                </select>
