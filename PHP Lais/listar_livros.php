        ...
        <table class="tableProdutos">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{Estoque}</td>
              <td>
                <button class="btnEditar"><a href="editar-livro.html">Editar</a></button>
            ...
            <tr>
                ...
                <td>{Estoque}</td>
                <td>
                  <button class="btnEditar"><a href="editar-livro.html">Editar</a></button>                    <button class="btnExcluir">Excluir</button>
                </td>
            </tr>
