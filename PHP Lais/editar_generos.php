...
<head>
    ...
    <link rel="stylesheet" href="editar-genero.css">
</head>
<body>
        ...
        <form class="dados">
            ...
            <div id="dados-direita">
                <div class="genero-dropdown">
                    <input type="text" placeholder="Gênero:" class="genero">
                ...
                <textarea class="descricao" name="descricao" placeholder="Descrição:"></textarea>
                <button><a href="../index/index.html">Editar</a></button>
            </div>
